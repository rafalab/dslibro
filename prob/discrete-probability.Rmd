...
[fix two sent a contradiction?] Si bien la palabra probabilidad se usa en el lenguaje cotidiano, responder a preguntas sobre la probabilidad es difícil, si no imposible. Aquí discutimos una definición matemática de _probabilidad_ que nos permite dar respuestas precisas a ciertas preguntas.
...
Pero debemos tener mucho cuidado antes de usar esto ya que suponer independencia cuando en realidad no existe puede resultar en cálculos de probabilidad muy diferentes e incorrectos.
...
Y luego verificar si una carta es un As y la otra una figura o un 10. De ahora en adelante, incluimos 10 cuando decimos _carta de figura_ o _figura_. Ahora necesitamos verificar ambas probabilidades:
