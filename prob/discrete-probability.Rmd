...
$$
Usemos el juego de cartas Blackjack como ejemplo. En Blackjack, se les asignan dos cartas al azar. Después de ver lo que tienen, pueden pedir más. El objetivo es acercarse más a 21 que el croupier, sin pasar. Las _cartas con figuras_  o _figuras_ (_face cards_ en inglés) valen 10 puntos y las A ses valen 11 o 1 (uno elige).
...
[fix check para] En la última línea, suponemos que el As es la primera carta que nos dan. Esto es solo porque sabemos cómo `combination` enumera las posibilidades y enumerará este caso primero. Pero para estar seguros, podríamos haber escrito esto y producido la misma respuesta:
