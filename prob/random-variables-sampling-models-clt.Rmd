...
En la ciencia de datos, a menudo tratamos datos que se ven afectados por casualidad de alguna manera: los datos provienen de una muestra aleatoria, los datos se ven afectados por un error de medición o los datos miden algún resultado que es de naturaleza aleatoria. Ser capaz de cuantificar la incertidumbre introducida por la aleatoriedad es uno de los trabajos más importantes de un analista de datos. La inferencia estadística ofrece un marco, así como varias herramientas prácticas para hacerlo. El primer paso es aprender a describir matemáticamente variables aleatorias.
...
Las variables aleatorias son resultados numéricos resultantes de procesos aleatorios. Podemos generar fácilmente variables aleatorias utilizando algunos de los ejemplos simples que hemos mostrado. Por ejemplo, definir `X` ser 1 si una cuenta es azul y roja de lo contrario:
