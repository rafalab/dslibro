...
$$
con $Z$ una variable aleatoria normal estándar como se muestra anteriormente. [fix check] Si definimos $\mu$ y $\sigma$ para ser respectivamente el valor esperado y la desviación estándar de la urna (es decir, de un solo préstamo), usando las fórmulas anteriores tenemos: $\mbox{E}[S]= n\mu$ y $\mbox{SE}[S]= \sqrt{n}\sigma$. Entonces, si definimos $z$=`qnorm(0.01)`, tenemos:
$$
