...
La creciente disponibilidad de sets de datos informativos y de herramientas de software ha llevado a una mayor dependencia de la **visualización de datos** en muchos campos. En la segunda parte, demostramos cómo usar __ggplot2__ para generar gráficos y describir principios importantes de la visualización de datos.
