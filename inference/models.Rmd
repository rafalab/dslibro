...
>> Si cree que la elección está pareja, apostemos. Si Obama gana, Ud. dona $1,000 a la Cruz Roja Americana. Si Romney gana, yo lo hago. ¿De acuerdo?
...
A diferencia de la definición de desviación estándar de la población, ahora dividimos por $N-1$. Esto hace $s$ un mejor estimado de $\sigma$. Hay una explicación matemática para esto, que se enseña en la mayoría de los libros de texto de estadística, pero no la cubrimos aquí.
