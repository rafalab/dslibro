...
10\. [fix eng chnage first poll to pollseter] Supongamos que definimos $\bar{Y}_1$ como el promedio de los resultados de la encuesta del primer encuestador, $Y_{1,1},\dots,Y_{1,N_1}$ con $N_1$ el número de encuestas realizadas por el primer encuestador:
