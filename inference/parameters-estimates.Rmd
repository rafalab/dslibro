...
7\. Si nos interesa la diferencia en proporciones, $p - (1-p)$, nuestra estimación es $d = \bar{X} - (1-\bar{X})$. Use las reglas que aprendimos sobre sumas de variables aleatorias y variables aleatorias [fix] escaladas para derivar el valor esperado de $d$.
