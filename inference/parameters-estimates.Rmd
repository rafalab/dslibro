...
Usando lo que ya hemos aprendido, el valor esperado de la suma $N\bar{X}$ es $N \times$ el promedio de la urna, $p$. Entonces dividiendo por la constante no aleatoria $N$ nos da que el valor esperado del promedio $\bar{X}$ es $p$. Podemos escribirlo usando nuestra notación matemática:
