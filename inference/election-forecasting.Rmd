...
Tengan en cuenta que $h_i$ es común a todas las variabilidades observadas de un encuestador específico. Diferentes encuestadores tienen un diferente $h_i$, lo que explica por qué podemos ver los grupos de puntos desplazarse hacia arriba y hacia abajo [fix] de encuestador a encuestador.
