...
¿Podemos responder a esta pregunta? Podemos usar el truco matemático que aprendimos en el capítulo anterior. Resten el valor esperado y dividan por el error estándar para obtener una variable aleatoria normal estándar, llámenla $Z$, a la izquierda. Ya que $p$ es el valor esperado y $\mbox{SE}(\bar{X}) = \sqrt{p(1-p)/N}$ es el error estándar, obtenemos:
