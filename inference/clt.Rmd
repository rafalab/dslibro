...
1\. Escriba una función que modele una urna que toma la proporción de demócratas $p$ y el tamaño de la muestra $N$ como argumentos y devuelva el promedio de la muestra si los demócratas son 1s y los republicanos son 0s. Nombre la función `take_sample`.
