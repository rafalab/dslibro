...
5\. Now edit the code above to redefine `dat` so that the levels of the state variable are re-ordered by the rate variable. Then make a bar-plot using the code above, but for this new `dat`.
