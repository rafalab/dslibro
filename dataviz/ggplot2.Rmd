...
Primero, las escalas que queremos están en escala logarítmica. Este no es el valor predeterminado, por lo que este cambio debe agregarse a través de una capa de _escalas_. Una mirada rápida a la hoja de referencia revela que la función `scale_x_continuous` nos permite controlar el comportamiento de las escalas. La usamos así:
