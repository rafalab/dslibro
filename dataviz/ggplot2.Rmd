...
Para usar __ggplot2__, tendrán que aprender varias funciones y argumentos. Estos son difíciles de memorizar, por lo que les recomendamos que tengan a mano la hoja de referencia de ggplot2. Pueden obtener una copia en línea^[https://github.com/rstudio/cheatsheets/raw/master/data-visualization-2.1.pdf] o simplemente realizar una búsqueda en internet de "ggplot2 cheat sheet".
