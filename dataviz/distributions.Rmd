...
Ya no queremos que `geom_bar` cuente, sino simplemente grafique una barra a la altura proporcionada por la variable `proportion`. Para esto necesitamos proveer `x` (las categorías) e `y` (los valores) y usar la opción `stat="identity"`.
