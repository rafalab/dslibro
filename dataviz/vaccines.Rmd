...
[fix check eng] Agregamos una línea vertical en 1963, ya que es cuando se introdujo la vacuna [Control, Centers for Disease; Prevention (2014). CDC health information for international travel 2014 (the yellow book). p. 250. ISBN 9780199948505].
...
4. Ahora haga lo mismo con las tarifas para Estados Unidos. Sugerencia: calcule la tasa de EE. UU. [fix eng too] usando el resumen: total dividido por población total. "Now do the same for the rates for the US. Hint: compute the US rate by using summarize: the total divided by total population."
