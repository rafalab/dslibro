...
Mirar los números y las cadenas de caracteres que definen un set de datos rara vez es útil. Para confirmar esto, impriman y observen la tabla de datos de asesinatos de Estados Unidos:
...
Muchas herramientas ampliamente utilizadas de análisis de datos fueron iniciadas por descubrimientos realizados a través de EDA. El EDA es quizás la parte más importante del análisis de datos, pero a menudo se ignora.
