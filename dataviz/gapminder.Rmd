...
Tengan en cuenta que tenemos que invertir el `x` y `y` que se usaron para el diagrama de caja. [fix eng too] Un parametro útil de `geom_density_ridges` es `scale`, que les permite determinar cuánto superponer; por ejemplo, `scale = 1` significa que no hay superposición. Valores mayores que 1 resultan en mayor superposición.
