...
1. [fix] Esperanza de vida alrededor de 70 años y 3 o menos hijos por familia.
...
[fix] Así logramos un vistazo de cerca de los países de ingresos medios a bajos.
...
En la base 10, esto se convierte en un rango que incluye muy pocos enteros: solo 0 y 1. Con la base dos, nuestro rango incluye -2, -1, 0, 1, 2, 3, 4 y 5. Es más fácil calcular $2^x$ y $10^x$ cuando $x$ es un entero y entre -10 y 10, por lo que preferimos tener enteros más pequeños en la escala. Otra consecuencia de un rango limitado es que elegir [fix] binwidth/ el ancho del compartimiento es más difícil. Con log base 2, sabemos que un  [fix] binwidth de 1 se convertirá en un compartimiento con rango $x$ a $2x$.
...
Rehacemos los gráficos utilizando solo países con datos disponibles para ambos años. En la parte de discusión de datos de este libro, aprenderemos herramientas __tidyverse__ que nos permiten escribir código eficiente para esto, pero aquí podemos usar código simple usando `intersect` función:
...
Ahora, de vuelta a nuestra trama. Con base en el gráfico anterior, ¿concluimos que un país con bajos ingresos está destinado a tener una tasa de supervivencia baja? ¿Llegamos a la conclusión de que las tasas de supervivencia en el África subsahariana son más bajas que en el sur de Asia, que a su vez son más bajas que en las islas del Pacífico, y así sucesivamente?
