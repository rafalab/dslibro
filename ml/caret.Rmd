...
Observamos que los estimados de exactitud son más variables, algo esperado ya que cambiamos el número de muestras utilizadas para estimar la exactitud.
...
y produce un estimado más suave de la probabilidad condicional:
