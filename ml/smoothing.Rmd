...
Esta suposición implica que un buen estimado de $f(x)$ es el promedio de $Y_i$ valores en la ventana. Si definimos $A_0$ como el conjunto de índices $i$ tal que $|x_i - x_0| \leq 3.5$ y $N_0$ como el número de índices en $A_0$, entonces nuestro estimado es:
...
Podemos ver cómo diferentes tamaños de ventanas, _spans_, conducen a diferentes estimados:
