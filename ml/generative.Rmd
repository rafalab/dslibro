...
El enfoque _Naive Bayes_ nos da una forma directa de corregir esto, ya que simplemente podemos forzar $\hat{\pi}$ a ser el valor que queremos. Entonces, para equilibrar la especificidad y la sensibilidad, en lugar de cambiar el umbral en la regla de decisión, simplemente podríamos cambiar $\hat{\pi}$ a 0.5 así:
