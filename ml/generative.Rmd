...
Cuando forzamos esta suposición, podemos mostrar matemáticamente que el límite es una línea, al igual que con la regresión logística. Por esta razón, llamamos al método _análisis lineal discriminante_ (LDA). Del mismo modo, para QDA, podemos mostrar que el límite debe ser una función cuadrática.
