...
3\. Creé un índice `ind` con los números de columna de los predictores que eran "estadísticamente significativos" asociados con `y`. Defina "estadísticamente significativo" como un valor-p menor que 0.01.  ¿Cuántos predictores sobreviven este umbral?
