...
Arriba vemos un gráfico del verdadero $p(x,y)$. Para comenzar a entender las limitaciones de la regresión logística aquí, primero tengan en cuenta que con la regresión logística $\hat{p}(x,y)$ tiene que ser un plano y, como resultado, el límite definido por la regla de decisión lo da:
