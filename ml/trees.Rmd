...
Una forma útil de comprender la maldición de la dimensionalidad es considerar cuán grande tenemos que hacer un vecindario (_neighborhood_) para incluir un porcentaje dado de los datos. Recuerden que con vecindarios más grandes, nuestros métodos pierden flexibilidad.
