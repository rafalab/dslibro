...
Podríamos eliminar atributos que no tienen variación ya que estas no nos ayuda a predecir. En la Sección \@ref(matrices), describimos las operaciones utilizadas para extraer columnas:
