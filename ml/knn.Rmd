...
Introdujimos el algoritmo kNN en la Sección \@ref(knn-cv-intro) y demostramos cómo usamos la validación cruzada para elegir $k$ en la Sección \@ref(caret-cv). Aquí revisamos rápidamente cómo ajustamos un modelo kNN usando el paquete __caret__. En la Sección \@ref(caret-cv), presentamos el siguiente código para que se ajuste a/para ajustar un modelo kNN:
...
Un gráfico de la probabilidad condicional estimada muestra que el estimado de kNN es lo suficientemente flexible para capturar la forma de la probabilidad condicional verdadera.
