...
El paquete __caret__ incluye una función que recomienda que se eliminen estas características debido a que la variación es casi cero:
...
Aunque no hemos explicado muchos de estos algoritmos, aplíquelos usando `train` con todos los parámetros predeterminados. Mantenga los resultados en una lista. Es posible que tenga que instalar algunos paquetes. Tenga en cuenta que probablemente recibirá algunas advertencias.
