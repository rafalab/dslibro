...
Aquí cubrimos varios pasos comunes del proceso del _wrangling_ de datos, incluyendo cómo convertir los datos en formato _tidy_, procesar cadenas, leer y procesar (_parse_ en inglés) html, trabajar con fechas y horas y _mineria de textos_ (_text mining_ en inglés). Raras veces se necesita hacer todos estos pasos de _wrangling_ en un solo análisis, pero los científicos de datos probablemente los enfrentarán a todos en algún momento. Algunos de los ejemplos que utilizamos para demostrar las técnicas del _wrangling_ de datos se basan en el trabajo que hicimos para convertir datos sin procesar en los sets de datos _tidy_ ofrecidos por el paquete __dslabs__ y utilizados en el libro como ejemplos.
