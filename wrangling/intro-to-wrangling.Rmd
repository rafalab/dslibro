...
Sin embargo, es bien raro que en un proyecto de ciencia de datos haya datos fácilmente disponibles como parte de un paquete. Hicimos un buen trabajo "tras bastidores" para convertir los datos originales en las tablas _tidy_ con las que trabajaron. Mucho más común es que los datos estén en un archivo, una base de datos o extraídos de un documento, incluyendo páginas web, tweets o PDF. En estos casos, el primer paso es importar los datos a R y, cuando usando __tidyverse__, ordenar los datos. Este paso inicial en el proceso de análisis de datos generalmente implica varios pasos, a menudo complicados, para convertir datos de su forma sin formato al formulario _tidy_ que facilita enormemente el resto del análisis. Nos referimos a este proceso como `data wrangling`.
