...
La función `extract` del paquete __tidyr__ nos permite usar grupos _regex_ para extraer los valores deseados. Aquí está el equivalente al código anterior [fix eng too 'que usa `separate`] usando `separate`, pero ahora usando `extract`:
