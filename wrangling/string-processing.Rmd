...
Observen que las segunda y tercera columnas contienen pies y pulgadas, respectivamente. La primera columna es la parte de la cadena que corresponde con el patrón. Si no se produjo ninguna equivalencia, vemos un `NA`.
...
Si hacemos este reemplazo antes de encontrar la equivalencia, obtendremos muchas más equivalencias:
