...
El resultado no es exactamente lo que llamamos _tidy_ ya que cada observación está asociada con dos filas en vez de una. Queremos tener los valores de las dos variables, fertilidad y esperanza de vida, en dos columnas separadas. El primer reto para lograr esto es separar la columna `key` en año y tipo de variable. Observen que las entradas en esta columna separan el año del nombre de la variable con una barra baja:
