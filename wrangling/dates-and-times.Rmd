...
Funciones que grafican, como las de __ggplot__, conocen el formato de fecha. Esto significa que, por ejemplo, un diagrama de dispersión puede usar la representación numérica para decidir la posición del punto, pero incluir la cadena en las etiquetas:
...
El paquete también incluye una función para convertir cadenas en horas del día, así como funciones que convierte, objetos de horas del día que también incluyen fechas:
