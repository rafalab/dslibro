...
En la sección de ejercicio anterior, [fix "we wrangled data from a PDF file"] recopilamos datos de un archivo PDF que contiene estadísticas vitales de Puerto Rico. Hicimos esto para el mes de septiembre. A continuación incluimos un código que lo hace durante los 12 meses.
