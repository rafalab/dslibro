...
1\. Instale y cargue la biblioteca __Lahman__. Esta base de datos incluye datos relacionados con equipos de béisbol. Incluye estadísticas sobre cómo se desempeñaron los jugadores ofensiva y defensivamente durante varios años. También incluye información personal sobre los jugadores.
...
Queremos ver si la tendencia mensual está cambiando, por lo que eliminaremos los efectos del año y luego graficaremos los resultados. Primero calcularemos los promedios del año. Utilice `group_by` y `summarize` para calcular el co2 promedio de cada año. Guardar en un objeto llamado `yearly_avg`.
