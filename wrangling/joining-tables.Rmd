...
Aunque todavía no lo hemos usado en este libro, otra forma común en la que se combinan los sets de datos es pegándolos (_binding_ en inglés). A diferencia de las funciones _join_, las funciones _binding_ no intentan coincidir con una variable, sino que simplemente combinan sets de datos. Si los sets de datos no coinciden con las dimensiones apropiadas, se obtiene un error.

### Pegando columnas

La función _bind_cols_ de __dplyr__ pega dos objetos convirtiéndolos en columnas en un tibble. Por ejemplo, queremos crear rápidamente un _data frame_ que consista de números que podemos usar.
