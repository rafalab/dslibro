...
Esto claramente no es un set de datos _tidy_, ni siquiera un _data frame_. En el código anterior, claramente podemos ver un patrón y es muy factible escribir código para extraer solo los datos. De hecho, __rvest__ incluye una función solo para convertir tablas HTML en _data frames_:
...
13\. Avanzado. Extraiga los títulos de las películas que ganaron el premio de la Mejor Película de este sitio web: [https://m.imdb.com/chart/bestpicture/font](https://m.imdb.com/chart/bestpicture/)
