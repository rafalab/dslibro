...
[fix] Al leer hojas de cálculo, muchas cosas pueden salir mal. El archivo puede tener un encabezado multilínea, pueden faltar celdas o puede usar una codificación inesperada^[https://en.wikipedia.org/wiki/Character_encoding]. Les recomendamos que lean esta publicación sobre problemas comunes: [https://www.joelonsoftware.com/2003/10/08/the-absolute-minimum-every-software-developer-absolutely-positively-must-know-about -unicode-and-character-sets-no-excuses/] (https://www.joelonsoftware.com/2003/10/08/the-absolute-minimum-every-software-developer-absolutely-positively-must-know -about-unicode-and-character-sets-no-excuses/).

Con experiencia, aprenderán[fix] a lidiar con/manejar los diferentes retos. Le útil leer detenidamente los archivos de ayuda para las funciones discutidas aquí. Otras dos funciones que son útiles son `scan`. Con `scan` pueden leer cada celda de un archivo. Aquí hay un ejemplo:
...
Tengan en cuenta que el __tidyverse__ incluye `read_lines`, una función igualmente útil.
...
## La organizan datos con las hojas de cálculo

Aunque este libro se centra casi exclusivamente en el análisis de
datos, la gestión de datos también es una parte importante de la
...
de manera que la forma más convenientemente de almacenarlos es en una
...
este formato. Recomendamos Google Sheets como una herramienta de
