...
Este código no lee los datos en R, solo copia un archivo. Pero una vez copie el archivo, podemos importar los datos con solo una línea de código. Aquí usamos la función `read_csv` del paquete __readr__, que forma[fix] parte del __tidyverse__.
...
En esta sección presentamos las principales funciones de importación[fix] del _tidyverse_. Utilizaremos el archivo `murders.csv` del paquete __dslabs__ como ejemplo. Para simplificar la ilustración, copiaremos el archivo a nuestro directorio de trabajo usando el siguiente código:
