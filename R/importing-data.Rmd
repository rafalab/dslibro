...
Los datos se importan y almacenan en `dat`. El resto de esta sección define algunos conceptos importantes y pfrece una visión general de cómo escribimos código que le dice a R cómo encontrar los archivos que queremos importar. Capítulo \@ref(unix) provee más detalles sobre este tema.
...
En esta sección presentamos las principales funciones de importación del __tidyverse__. Utilizaremos el archivo `murders.csv` del paquete __dslabs__ como ejemplo. Para simplificar la ilustración, copiaremos el archivo a nuestro directorio de trabajo usando el siguiente código:
...
El paquete ofrece funciones para leer (_read-in_ en inglés) formatos de Microsoft Excel:
