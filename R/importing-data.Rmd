...
Lea el archivo de ayuda para `read_csv` para aprender cómo leer el archivo sin leer este encabezado. Si omite el encabezado, no debería recibir esta advertencia. Guarde el resultado en un objeto llamado `dat`.
...
Con experiencia, aprenderán a manejar los diferentes retos. Les ayudará leer detenidamente los archivos de ayuda para las funciones discutidas aquí. Con `scan` pueden leer cada celda de un archivo, como vemos aquí:
...
* __Utilice la validación de datos para evitar errores__ - Aproveche las herramientas en su _software_ de hoja de cálculo para que el proceso sea lo más libre de errores y  de lesiones por estrés repetitivo posible.
