...
Use la función `mutate` para agregar una columna de asesinatos llamada `rate` con la tasa de asesinatos por 100,000 como en el código del ejemplo anterior. Asegúrese de redefinir `murders` como se hizo en el código del ejemplo anterior (murders <- [su código]) para que podamos seguir usando esta variable.
