...
Suponga que queremos tres resúmenes de una variabla, como por ejemplo la mediana, el mínimo, y le máximo. Podemos usar `summarize` así:
...
Ahora, noten que los resúmenes se devuelven en filas separadas. Para obtenerlos en columnas, tenemos aue definir una función que devuelve un data frame así:
...
En la próxima sección vermos cúan útil esto puede ser cuando resumimos por grupo.
