...
Esta es una de las principales características de __dplyr__. Las funciones en este paquete, como `mutate`, saben buscar variables en el _data frame_ que el primer argumento le provee. En la llamada a mutar (_mutate_ en inglés) que vemos arriba, `total` [fix] tendrá los valores en/de? `murders$total`. Este enfoque hace que el código sea mucho más legible.
