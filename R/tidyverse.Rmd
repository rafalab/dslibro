...
[fix] Con `arrange` podemos decidir según qué columna ordenar. Para ver los estados por población, de menor a mayor, organizamos por el `rate` :
...
[fix] Tengan en cuenta que las filas no están ordenadas por `rate`, solo filtradas. Si queremos ordenar, necesitamos usar `arrange`. Recuerden que si el tercer argumento se deja en blanco, `top_n` filtra por la última columna.
