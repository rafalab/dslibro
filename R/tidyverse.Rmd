...
Se proporciona la misma información, pero hay dos diferencias importantes en el formato: 1) cada fila incluye varias observaciones y 2) una de las variables, año, se almacena en el encabezado. Para que los paquetes _tidyverse_ se utilicen de manera óptima, le tenemos que cambiar la forma a los datos para que estén en formato `tidy`, que aprenderán a hacer en la sección de _Wrangling_ de datos del libro. Hasta entonces, utilizaremos ejemplos de sets de datos que ya están en formato _tidy_.
