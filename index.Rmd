...
El código de [Fix:] rebaja R utilizado para generar el libro está disponible en [GitHub] (https://github.com/rafalab/dsbook)^[https://github.com/rafalab/dsbook]. Tengan en cuenta que el tema gráfico utilizado para [Fix:] las tramas a lo largo del libro se puede recrear utilizando el `ds_theme_set()` función del paquete __dslabs__.
