...
Pueden ver que $X$ y $Y$ están correlacionados negativamente. Sin embargo, una vez que estratificamos por $Z$ (se muestra en diferentes colores a continuación), surge otro patrón:
...
Realmente es $Z$ que está negativamente correlacionada con $X$. Si estratificamos por $Z$, $X$ y $Y$ están positivamente correlacionadas como se observa en el gráfico anterior.
