...
Además, hay métodos robustos para ajustar modelos lineales que pueden aprender, por ejemplo, en este libro: _Robust Statistics: Edition 2_ de Peter J. Huber y Elvezio M. Ronchetti.
...
```
-->
También desglosamos las aceptaciones por concentración. Este gráfico nos permite ver que la mayoría de los hombres aceptados provenían de dos concentraciones: A y B. Además nos permite ver que pocas mujeres solicitaron estas concentraciones.
...
Realmente es $Z$ que está negativamente correlacionada con $X$. Si estratificamos por $Z$, las $X$ y $Y$ están positivamente correlacionadas como se observa en el gráfico anterior.
