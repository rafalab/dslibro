...
De hecho, parece que los BB y los HR también están asociados:
...
Sabemos que los HR causan carreras porque, como su nombre sugiere, cuando un jugador logra un jonrón, se le garantiza al menos una carrera. ¿Podría ser que los HR también causen BB y esto hace que parezca que la causa BB se ejecuta? Cuando esto sucede, decimos que hay _confusión_, un concepto importante sobre el que aprenderemos más a lo largo de este capítulo.
