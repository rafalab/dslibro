...
El error estándar para la predicción usando regresión es sustancialmente más pequeño:
...
Calculamos una línea de regresión para predecir la altura del hijo basado en la altura del padre. Utilizamos estos cálculos:
